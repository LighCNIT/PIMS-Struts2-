...
<html>
    ...
    <body bgcolor="gray">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
          <tr>
              <td width="30%">
                  <s:a href="http://localhost:8080/PIMS-Struts2/dateTimeManager/addDay.jsp">增加日程</s:a>
              </td>
              <td width="30%">
                  <s:a href="http://localhost:8080/PIMS-Struts2/dateTimeManager/lookDay.jsp">查看日程</s:a>
              </td>
              <td width="40%">
