...
<body bgcolor="gray">
		...
		<s:form action="findFriAction" method="post">
			<table border="0" cellspacing="0" cellpadding="0" width="100%"
				...
				<tr>
					...
					<td width="33%"><s:a
							href="http://localhost:8084/ch13/friendManager/lookFriends.jsp">查看联系人</s:a>
					</td>
	...
	<form action="addFriAction" method="post">
		<table border="2" cellspacing="0" cellpadding="0" bgcolor="95BDFF"
			...
			<tr>
				<td><s:textfield name="workplace" label="工作单位"></s:textfield></td>
			</tr>
			<tr>
				<td><s:textfield name="place" label="家庭住址"></s:textfield></td>
			</tr>
			<tr>
