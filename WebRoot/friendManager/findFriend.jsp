...
<html>
    ...
    <body bgcolor="gray">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
          <tr>
              <td width="33%">
                  <s:a href="http://localhost:8084/ch13/friendManager/addFriend.jsp">增加联系人</s:a>
              </td>
              <td width="33%">
                  <s:a href="http://localhost:8084/ch13/friendManager/lookFriends.jsp">查看联系人</s:a>
              </td>
              <td width="33%">
            ...
            <%
                ...
                for(int i=friends.size()-1;i>=0;i--){
                   ...
                   <tr>
                     ...
                     <td><%=ff.getQQ()%></td>
                     <td>
                         <s:a href="http://localhost:8084/ch13/friendManager/updateFriend.jsp">修改</s:a>
